...
def get_true_pred_arr(
    ...
    **classifier_kwargs,
    ...
    img_dir : str representing path to a directory, optional
        Path to the directory where the images from `val_df` are located. Required if
        `val_df` is provided. Ignored if `img_filepaths` is provided.
    ...
    img_filename_pattern : str representing a file-name pattern, optional
        ...
        Ignored if `val_df` or `img_filepaths` is provided.
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        true_arrs = []
        pred_arrs = []
        for pred_img_filepath in pred_imgs:
            with rio.open(
